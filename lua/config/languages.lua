--- We support override this config via a project-local `.langconfig.lua`
...
local local_opts = Utils.lang.resolve_local() or {}
opts = vim.tbl_extend("keep", local_opts, opts)
local merged = Utils.lang.merge(opts)
merged.treesitters = Utils.dedup(vim.list_extend(merged.treesitters, must_installed_treesitter))

_G.LangSettings = merged
